...
- `BOOM_ENTRY_WINDOW_MS`: Random mode only. How long the entry window stays open from 12:00:00 local, in milliseconds. Optional; default `600000` (10 minutes), i.e. entries count from 12:00:00 up to but not including 12:10:00. Points are assigned 5s after it shuts.
