...
- Boom module:
  ...
  - Deploy day: the day you deploy is scored and announced under the new rules, including entries recorded before the deploy. Dates before the stamped `random_scoring_from` stay on legacy 3-2-1 scoring and are never settled or re-rolled; if the old build already announced today, the cutover moves to tomorrow and today keeps its posted podium.
